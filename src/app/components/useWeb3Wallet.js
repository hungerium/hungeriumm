...
export default function useWeb3Wallet() {
  ...
  // Token configuration
  const TOKEN_CONFIG = {
    address: '0x33AA3dbCB3c4fF066279AD33099Ce154936D8b88',
    decimals: 18,
    symbol: 'COFFY',
    name: 'Coffy'
  };
