...
// Web3 Constants
export const TOKEN_ADDRESS = '0x04CD0E3b1009E8ffd9527d0591C7952D92988D0f';
...
export const SVG_URLS = {
    ...
    // Beyaz kahve fincanı
    coffeeCup: "data:image/svg+xml;charset=utf-8," + encodeURIComponent(`
        <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <radialGradient id="coffeeGrad" cx="50%" cy="40%" r="70%" fx="50%" fy="30%">
                    <stop offset="0%" style="stop-color:#BB9977;stop-opacity:0.6" />
                    <stop offset="80%" style="stop-color:#EEDDCC;stop-opacity:0.8" />
            ...
            <!-- Gölge -->
            <ellipse cx="50" cy="85" rx="18" ry="5" fill="rgba(0,0,0,0.2)" />
            
            <!-- Fincan gövdesi - beyaz porselen -->
            <g filter="url(#shadow)">
                <!-- Kahve bardağı - modern, geniş form, beyaz -->
                <path d="M35 50 L35 75 C35 82, 50 85, 50 85 C50 85, 65 82, 65 75 L65 50 C65 45, 60 44, 60 44 L40 44 C40 44, 35 45, 35 50 Z" fill="url(#cupGrad)" stroke="#DDDDDD" stroke-width="1.5" />
                
                <!-- Bardak detayları -->
                <path d="M35 56 L65 56" stroke="#CCCCCC" stroke-width="0.7" stroke-opacity="0.7" stroke-dasharray="2,1" />
                <path d="M35 63 L65 63" stroke="#CCCCCC" stroke-width="0.7" stroke-opacity="0.7" stroke-dasharray="2,1" />
                <path d="M35 70 L65 70" stroke="#CCCCCC" stroke-width="0.7" stroke-opacity="0.7" stroke-dasharray="2,1" />
                
                <!-- Kahve yüzeyi - düşük kontrastlı açık kahve -->
                <ellipse cx="50" cy="47" rx="12" ry="4" fill="url(#coffeeGrad)" />
                
                <!-- Köpük -->
                <path d="M44 46 C45 44, 48 44, 49 46 M51 46 C52 44, 55 44, 56 46" stroke="#FFFFFF" stroke-width="1.2" fill="none" />
                <ellipse cx="50" cy="46" rx="10" ry="1" fill="rgba(255,255,255,0.5)" />
                
                <!-- Kulp - beyaz, zarif -->
                <path d="M65 55 L72 55 L72 65 L65 65" stroke="#DDDDDD" stroke-width="2" fill="none" />
                
                <!-- Logo/işaret - zarif çizgi -->
                <circle cx="50" cy="64" r="3" fill="#EEEEEE" opacity="0.5" />
                
                <!-- Buhar -->
                <g filter="url(#steamFilter)" opacity="0.7">
                    <path d="M45 43 C45 38, 42 35, 45 30 C48 25, 45 20, 45 15" stroke="#AAAAAA" stroke-width="1.2" fill="none" />
                    <path d="M50 43 C50 33, 53 28, 50 23 C47 18, 50 13, 50 8" stroke="#AAAAAA" stroke-width="1.2" fill="none" />
                    <path d="M55 43 C55 38, 58 35, 55 30 C52 25, 55 20, 55 15" stroke="#AAAAAA" stroke-width="1.2" fill="none" />
                </g>
            </g>
        </svg>
    `),
    
    // Koyu çay rengi fincanı - daha görünür
    teaCup: "data:image/svg+xml;charset=utf-8," + encodeURIComponent(`
        <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <radialGradient id="teaGrad" cx="50%" cy="40%" r="70%" fx="50%" fy="30%">
                    <stop offset="0%" style="stop-color:#8B4513;stop-opacity:0.95" />
                    <stop offset="70%" style="stop-color:#704214;stop-opacity:0.95" />
                    <stop offset="100%" style="stop-color:#5E370F;stop-opacity:1" />
                </radialGradient>
                ...
                <pattern id="grainPattern" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                    ...
                    <rect x="0" y="0" width="10" height="10" fill="#704214" opacity="0.5" />
                    <rect x="10" y="10" width="10" height="10" fill="#704214" opacity="0.5" />
                </pattern>
            </defs>
            
            <!-- Gölge -->
            <ellipse cx="50" cy="85" rx="16" ry="3" fill="rgba(0,0,0,0.3)" />
            
            <!-- Fincan altlığı -->
            <ellipse cx="50" cy="82" rx="20" ry="4" fill="#8B4513" stroke="#654321" stroke-width="0.8" filter="url(#teaShadow)" />
            
            <!-- Çay fincanı gövdesi - ön planda ve koyu kahverengi -->
            <g filter="url(#teaShadow)">
                <!-- Çay fincanı - özel form, koyu renk -->
                <path d="M40 52 C40 65, 37 75, 50 78 C63 75, 60 65, 60 52 C60 48, 58 47, 55 47 L45 47 C42 47, 40 48, 40 52 Z" fill="url(#teaCupGrad)" stroke="#654321" stroke-width="1.5" />
                
                <!-- Çizgili desen -->
                <path d="M44 55 C44 60, 42 70, 50 74 C58 70, 56 60, 56 55" fill="url(#grainPattern)" opacity="0.6" />
                
                <!-- Çay yüzeyi - daha büyük ve parlak -->
                <ellipse cx="50" cy="52" rx="8" ry="3.5" fill="url(#teaGrad)" filter="url(#teaGlow)" />
                
                <!-- Çay yaprağı - daha belirgin -->
                <path d="M48 51 C49 49, 53 49, 54 51" stroke="#CD853F" stroke-width="1.2" fill="#DEB887" />
                
                <!-- Çay fincanı kulpu - daha kalın -->
                <path d="M60 55 C65 55, 68 58, 68 62 C68 66, 65 69, 60 69" stroke="#654321" stroke-width="2" fill="none" />
                
                <!-- Çay fincanının üst kenarı - parlak vurgu -->
                <ellipse cx="50" cy="47" rx="8" ry="3" fill="none" stroke="#CD853F" stroke-width="0.8" />
                
                <!-- Parlak nokta efekti -->
                <circle cx="55" cy="53" r="1.5" fill="#CD853F" opacity="0.8" />
                <circle cx="45" cy="51" r="1" fill="#CD853F" opacity="0.6" />
                
                <!-- Buhar - daha yoğun/görünür -->
                <g opacity="0.7">
                    <path d="M47 49 C47 44, 44 42, 47 38 C50 34, 46 30, 46 27" stroke="#CD853F" stroke-width="1.2" fill="none" />
                    <path d="M50 49 C50 42, 53 40, 50 36 C47 32, 51 28, 50 24" stroke="#CD853F" stroke-width="1.2" fill="none" />
                    <path d="M53 49 C53 44, 56 42, 53 38 C50 34, 54 30, 53 27" stroke="#CD853F" stroke-width="1.2" fill="none" />
                </g>
            </g>
            
            <!-- Parlaklık efekti - daha fark edilir yapmak için -->
            <ellipse cx="50" cy="60" rx="15" ry="20" fill="rgba(139, 69, 19, 0.15)" filter="url(#teaGlow)" />
        </svg>
    `),
...
// Ses efektleri koleksiyonu
export const SOUND_EFFECTS = {
    PLAYER: {
        SHOOT: 'player_shoot.mp3',
        HIT: 'player_hit.mp3',
        POWERUP: 'player_powerup.mp3',
        SUPERPOWER: 'player_superpower.mp3',
        LEVEL_UP: 'player_level_up.mp3'
    },
    BOSS: {
        APPEAR: 'boss_appear.mp3',
        ATTACK: 'boss_attack.mp3',
        HIT: 'boss_hit.mp3',
        DEFEAT: 'boss_defeat.mp3'
    },
    GAME: {
        BACKGROUND: 'game_bg_music.mp3',
        MENU: 'menu_music.mp3',
        COLLECT_COFFEE: 'collect_coffee.mp3',
        COLLECT_TEA: 'collect_tea.mp3',
        BUTTON_CLICK: 'button_click.mp3'
    }
};

// COFFY Token ABI (Keep it here or move to a separate abi.js if preferred)
